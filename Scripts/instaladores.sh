...
#Para descargar el nuevo paquete de LibreOffice 7.2.0, vamos a ejecutar el siguiente comando:


wget http://download.documentfoundation.org/libreoffice/stable/7.2.0/deb/x86_64/LibreOffice_7.2.0_Linux_x86-64_deb.tar.gz

#Hecha la descarga ahora podemos extraer el contenido del archivo descargado con:


tar xvfz LibreOffice_7.2.0_Linux_x86-64_deb.tar.gz

#Entramos al directorio creado:

cd LibreOffice_7.2.0.2_Linux_x86-64_deb/DEBS/
...
cd ..
cd ..
wget http://download.documentfoundation.org/libreoffice/stable/7.2.0/deb/x86_64/LibreOffice_7.2.0_Linux_x86-64_deb_langpack_es.tar.gz

#Y procedemos a descomprimir ya instalar los paquetes resultantes:

tar xvfz LibreOffice_7.2.0_Linux_x86-64_deb_langpack_es.tar.gz
cd LibreOffice_7.2.0.2_Linux_x86-64_deb_langpack_es/DEBS/
sudo dpkg -i *.deb
